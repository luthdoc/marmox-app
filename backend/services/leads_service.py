...
def transition_to_handoff(tenant_id: str, lead_id: str) -> dict:
    ...
    Fetches the lead filtering by both id and tenant_id to enforce tenant isolation
    (in addition to RLS). Returns 409 if lead is already 'cold'.
    ...
    Raises:
        ...
        LeadStatusError: If lead status is 'cold' (regression forbidden).
    """
